...
select throws_ok($$select public.create_media_upload(gen_random_uuid(),pg_temp.flower(),'audio/webm',100)$$,'22023','media_wrong_flower','audio cannot attach to a photo flower');
